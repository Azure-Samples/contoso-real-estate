import { n as fu, o as cu } from "./wsPort-d13879e1.js";
var fa = { exports: {} };
(function (An, pi) {
  (function (X, lt) {
    An.exports = lt();
    ...
    var X = navigator.userAgent,
      ...
      Ce = /Android/.test(X),
      We = ie || Ce || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(X),
      me = ie || /Mac/.test(lt),
      st = /\bCrOS\b/.test(X),
      he = /win/i.test(lt),
    ...
    function z(e, t) {
      for (var n = e.split(" "), r = 0; r < n.length; r++) n[r] && !ut(n[r]).test(t) && (t += " " + n[r]);
      return t;
    }
    var K = function (e) {
      e.select();
    ...
    function vr(e, t) {
      var n;
      return Object.create ? (n = Object.create(e)) : ((Kt.prototype = e), (n = new Kt())), t && G(t, n), n;
    }
    var Qr =
      /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
    function tr(e) {
      return /\w/.test(e) || (e > "" && (e.toUpperCase() != e.toLowerCase() || Qr.test(e)));
    }
    function Gt(e, t) {
      return t ? (t.source.indexOf("\\w") > -1 && tr(e) ? !0 : t.test(e)) : tr(e);
    }
    function U(e) {
    ...
    var vi = (function () {
      ...
      return function (u, c) {
        ...
        for (var b = u.length, y = [], w = 0; w < b; ++w) y.push(n(u.charCodeAt(w)));
        ...
        for (var E = 0, A = h; E < b; ++E) {
          var I = y[E];
          I == "1" && A == "r" ? (y[E] = "n") : o.test(I) && ((A = I), I == "r" && (y[E] = "R"));
        }
        for (var B = 1, R = y[0]; B < b - 1; ++B) {
          var ee = y[B];
          ee == "+" && R == "1" && y[B + 1] == "1"
            ? (y[B] = "1")
            : ee == "," && R == y[B + 1] && (R == "1" || R == "n") && (y[B] = R),
            (R = ee);
        }
        for (var ce = 0; ce < b; ++ce) {
          ...
          if (_e == ",") y[ce] = "N";
            ...
            for (var dt = (ce && y[ce - 1] == "!") || (xe < b && y[xe] == "1") ? "1" : "N", nt = ce; nt < xe; ++nt)
              y[nt] = dt;
            ce = xe - 1;
          }
        }
        ...
        return (
          c == "ltr" &&
            (je[0].level == 1 &&
              (Rt = u.match(/^\s+/)) &&
              ((je[0].from = Rt[0].length), je.unshift(new s(0, 0, Rt[0].length))),
            te(je).level == 1 &&
              (Rt = u.match(/\s+$/)) &&
              ((te(je).to -= Rt[0].length), je.push(new s(0, b - Rt[0].length, b)))),
          c == "rtl" ? je.reverse() : je
        );
      };
    })();
    ...
    function yi(e) {
      if (St == null) {
        ...
        F(e, p("span", [t, document.createTextNode("x")])),
          e.firstChild.offsetHeight != 0 && (St = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(L && Y < 8));
      }
      var n = St ? p("span", "​") : p("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
...
`,
    ...
    function ct(e) {
      if (typeof e == "string" && nr.hasOwnProperty(e)) e = nr[e];
        ...
        var t = nr[e.name];
        typeof t == "string" && (t = { name: t }), (e = vr(t, e)), (e.name = t.name);
      } else {
      ...
      (ke.prototype.column = function () {
        return (
          this.lastColumnPos < this.start &&
            ...
            (this.lastColumnPos = this.start)),
          this.lastColumnValue - (this.lineStart ? _(this.string, this.lineStart, this.tabSize) : 0)
        );
      }),
    ...
    function le(e) {
      ...
      for (var t = e.parent, n = $(t.lines, e), r = t.parent; r; t = r, r = r.parent)
    ...
    function v(e, t, n) {
      if ((n === void 0 && (n = null), !(this instanceof v))) return new v(e, t, n);
    ...
    function Z(e, t) {
      ...
      return t.line > n ? v(n, P(e, n).text.length) : ca(t, P(e, t.line).text.length);
    }
    function ca(e, t) {
      var n = e.ch;
    ...
    (zt.prototype.lookAhead = function (e) {
      ...
      (zt.fromSaved = function (e, t, n) {
        return t instanceof zn ? new zt(e, Yt(e.mode, t.state), n, t.lookAhead) : new zt(e, Yt(e.mode, t), n);
      }),
            ...
            (n.state = !0),
              mo(
                ...
                function (y, w) {
                  for (var k = h; b < y; ) {
                    var T = i[h];
                    T > y && i.splice(h, 1, y, i[h + 1], T), (h += 2), (b = Math.min(y, T));
                  }
                  if (w)
                    if (c.opaque) i.splice(k, h - k, y, "overlay " + w), (h = k + 2);
                    else
                      for (; k < h; k += 2) {
                        var N = i[k + 1];
                        i[k + 1] = (N ? N + " " : "") + "overlay " + w;
    ...
    function ho(e, t, n) {
      if (!t.styles || t.styles[0] != e.state.modeGen) {
        var r = rn(e, le(t)),
          i = t.text.length > e.options.maxHighlightLength && Yt(e.doc.mode, r.state),
          o = co(e, t, r);
        i && (r.state = i),
    ...
    function go(e, t, n, r) {
      ...
      for (r && (c = []); (r || u.pos < t.ch) && !u.eol(); )
        (u.start = u.pos), (l = bi(o, u, s.state)), r && c.push(new vo(u, l, Yt(i.mode, s.state)));
      ...
      for (t == "" && yo(po(n, r.state), o); !c.eol(); ) {
        if (
          (c.pos > e.options.maxHighlightLength
            ? ((a = !1), l && mi(e, t, r, c.pos), (c.pos = t.length), (h = null))
    ...
    function ha(e, t, n) {
      for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), a = t; a > l; --a) {
        ...
        var s = P(o, a - 1),
          u = s.stateAfter;
        if (u && (!n || a + (u instanceof zn ? u.lookAhead : 0) <= o.modeFrontier)) return a;
      ...
      if (e)
        for (var i = 0; i < e.length; ++i) {
          ...
          if (a || (o.from == t && l.type == "bookmark" && (!n || o.marker.insertLeft))) {
            ...
            (r || (r = [])).push(new Hn(l, s ? null : o.from - t, o.to == null ? null : o.to - t));
          }
        }
      return r;
    }
    function xi(e, t) {
      ...
      if (!u) {
        var E = t.text.length - 2,
          A;
        if (E > 0 && a)
          for (var I = 0; I < a.length; ++I) a[I].to == null && (A || (A = [])).push(new Hn(a[I].marker, null, null));
        ...
        for (var l = r[o], a = l.find(0), s = 0; s < i.length; ++s) {
          ...
          if (!(x(u.to, a.from) < 0 || x(u.from, a.to) > 0)) {
            var c = [s, 1],
              h = x(u.from, a.from),
              b = x(u.to, a.to);
            (h < 0 || (!l.inclusiveLeft && !h)) && c.push({ from: u.from, to: a.from }),
              (b > 0 || (!l.inclusiveRight && !b)) && c.push({ from: a.to, to: u.to }),
              i.splice.apply(i, c),
              (s += c.length - 3);
          }
        }
    ...
    function So(e, t) {
      ...
      if (n)
        for (var i = void 0, o = 0; o < n.length; ++o)
          (i = n[o]),
            i.marker.collapsed && (t ? i.from : i.to) == null && (!r || wi(r, i.marker) < 0) && (r = i.marker);
      return r;
    }
    function Co(e) {
      return So(e, !0);
      ...
      if (l)
        for (var a = 0; a < l.length; ++a) {
          ...
          if (s.marker.collapsed) {
            ...
            if (
              !((c >= 0 && h <= 0) || (c <= 0 && h >= 0)) &&
              ((c <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? x(u.to, n) >= 0 : x(u.to, n) > 0)) ||
                (c >= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? x(u.from, r) <= 0 : x(u.from, r) < 0)))
            )
              return !0;
          }
        }
    ...
    function Sa(e) {
      for (var t, n; (t = Bn(e)); ) (e = t.find(1, !0).line), (n || (n = [])).push(e);
      return n;
    }
    function ki(e, t) {
      var n = P(e, t),
    ...
    function Do(e, t) {
      ...
      for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
        ...
        (r.pos = 0),
          (r.addToken = Na),
          In(e.display.measure) && (l = kt(o, e.doc.direction)) && (r.addToken = Oa(r.addToken, l)),
          (r.map = []);
        var a = t != e.display.externalMeasured && le(o);
        Ea(o, r, ho(e, o, a)),
          o.styleClasses &&
            (o.styleClasses.bgClass && (r.bgClass = z(o.styleClasses.bgClass, r.bgClass || "")),
            o.styleClasses.textClass && (r.textClass = z(o.styleClasses.textClass, r.textClass || ""))),
      ...
      return (
        ...
        r.pre.className && (r.textClass = z(r.pre.className, r.textClass || "")),
        r
      );
    }
    function Da(e) {
          ...
          for (var h = 0; ; ) {
            ...
            if (b[0] == "	") {
              ...
              b[0] ==
                `
`
                ? ((k = c.appendChild(p("span", b[0] == "\r" ? "␍" : "␤", "cm-invalidchar"))),
        ...
        if (((e.trailingSpace = a.charCodeAt(t.length - 1) == 32), n || r || i || u || o || l)) {
          ...
          r && (E += r), i && (E += i);
          var A = p("span", [c], E, o);
          if (l) for (var I in l) l.hasOwnProperty(I) && I != "style" && I != "class" && A.setAttribute(I, l[I]);
    ...
    function Ea(e, t, n) {
      ...
      for (var a = i.length, s = 0, u = 1, c = "", h, b, y = 0, w, k, T, N, E; ; ) {
        if (y == s) {
          (w = k = T = b = ""), (E = null), (N = null), (y = 1 / 0);
          for (var A = [], I = void 0, B = 0; B < r.length; ++B) {
            var R = r[B],
              ee = R.marker;
            if (ee.type == "bookmark" && R.from == s && ee.widgetNode) A.push(ee);
            else if (R.from <= s && (R.to == null || R.to > s || (ee.collapsed && R.to == s && R.from == s))) {
              if (
                (R.to != null && R.to != s && y > R.to && ((y = R.to), (k = "")),
                ee.className && (w += " " + ee.className),
                ee.css && (b = (b ? b + ";" : "") + ee.css),
                ee.startStyle && R.from == s && (T += " " + ee.startStyle),
                ee.endStyle && R.to == y && (I || (I = [])).push(ee.endStyle, R.to),
                ee.title && ((E || (E = {})).title = ee.title),
                ee.attributes)
              )
                for (var ce in ee.attributes) (E || (E = {}))[ce] = ee.attributes[ce];
              ee.collapsed && (!N || wi(N.marker, ee) < 0) && (N = R);
            } else R.from > s && y > R.from && (y = R.from);
          }
          if (I) for (var _e = 0; _e < I.length; _e += 2) I[_e + 1] == y && (k += " " + I[_e]);
          if (!N || N.from == s) for (var xe = 0; xe < A.length; ++xe) No(t, 0, A[xe]);
          if (N && (N.from || 0) == s) {
            if ((No(t, (N.to == null ? a + 1 : N.to) - s, N.marker, N.from == null), N.to == null)) return;
            N.to == s && (N = !1);
          }
        }
        if (s >= a) break;
        for (var dt = Math.min(a, y); ; ) {
          if (c) {
            ...
            if (!N) {
              ...
              t.addToken(t, Me, h ? h + w : w, T, s + Me.length == y ? k : "", b, E);
            }
            if (nt >= dt) {
              (c = c.slice(dt - s)), (s = dt);
              break;
    ...
    var Er = null;
    function Ia(e) {
      Er ? Er.ops.push(e) : (e.ownsGroup = Er = { ops: [e], delayedCallbacks: [] });
    }
    function Wa(e) {
    ...
    function Pe(e, t) {
      ...
      if (n.length) {
        var r = Array.prototype.slice.call(arguments, 2),
          i;
        Er ? (i = Er.delayedCallbacks) : on ? (i = on) : ((i = on = []), setTimeout(Pa, 0));
        for (
          var o = function (a) {
              i.push(function () {
    ...
    function Eo(e, t) {
      ...
      return n && n.line == t.line ? ((e.display.externalMeasured = null), (t.measure = n.measure), n.built) : Do(e, t);
    }
    function Ha(e, t) {
    ...
    function Li(e, t) {
      za(e, t), t.line.wrapClass ? (ln(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = "");
    ...
    function _a(e, t, n) {
      ...
      for (var r = ut("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0; i; i = o)
    ...
    function Wo(e, t, n) {
      if ((Fo(e, t.line, t, n, !0), t.rest)) for (var r = 0; r < t.rest.length; r++) Fo(e, t.rest[r], t, n, !1);
    }
    ...
    function zo(e, t, n) {
      ...
      if (e.rest) {
        ...
        for (var i = 0; i < e.rest.length; i++)
          if (le(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
      }
    }
    function Ka(e, t) {
      t = Dt(t);
    ...
    function Ir(e, t) {
      var n = le(t),
        r = Di(e, n);
      r && !r.text ? (r = null) : r && r.changes && (Oo(e, r, n, Ii(e)), (e.curOp.forceUpdate = !0)),
        r || (r = Ka(e, t));
      var i = zo(r, t, n);
    ...
    function qa(e, t, n, r) {
      ...
      if (o.nodeType == 3) {
        for (var c = 0; c < 4; c++) {
          ...
          for (; i.coverStart + a < i.coverEnd && H(t.line.text.charAt(i.coverStart + a)); ) ++a;
          if (
      ...
      if (L && Y < 9 && !l && (!u || (!u.left && !u.right))) {
        ...
        b ? (u = { left: b.left, right: b.left + Fr(e.display), top: b.top, bottom: b.bottom }) : (u = _o);
      }
      for (
        var y = u.top - t.rect.top, w = u.bottom - t.rect.top, k = (y + w) / 2, T = t.view.measure.heights, N = 0;
        N < T.length - 1 && !(k < T[N]);
        N++
      );
      var E = N ? T[N - 1] : 0,
      ...
      return (
        !u.left && !u.right && (I.bogus = !0), e.options.singleCursorHeightPerLine || ((I.rtop = y), (I.rbottom = w)), I
      );
    }
    function Xa(e, t) {
      if (!window.screen || screen.logicalXDPI == null || screen.logicalXDPI == screen.deviceXDPI || !Wn(e)) return t;
    ...
    function qn(e, t, n, r, i) {
      ...
      r || (r = "local");
      var l = Qt(t);
      if ((r == "local" ? (l += Gn(e.display)) : (l -= e.display.viewOffset), r == "page" || r == "window")) {
    ...
    function Oi(e, t, n) {
      ...
      var i = Pt(r, n),
        o = r.first + r.size - 1;
      if (i > o) return Ai(r.first + r.size - 1, P(r, o).text.length, null, 1, 1);
      t < 0 && (t = 0);
      for (var l = P(r, i); ; ) {
        var a = Ya(e, l, i, t, n),
    ...
    function Ya(e, t, n, r, i) {
        ...
        w = V(
          function (B) {
            ...
            return (
              (R.top += l),
              (R.bottom += l),
              Ei(R, r, i, !1) ? (R.top <= i && R.left <= r && ((b = B), (y = R)), !0) : !1
            );
          },
          a,
          s,
      ...
      if (y) {
        var E = r - y.left < y.right - r,
          A = E == u;
        (w = b + (A ? 0 : 1)), (T = A ? "after" : "before"), (k = E ? y.left : y.right);
      } else {
        !u && (w == s || w == a) && w++,
          (T =
            w == 0
    ...
    function ja(e, t, n, r, i, o, l) {
      var a = V(
          function (h) {
            var b = i[h],
              y = b.level != 1;
            return Ei(Nt(e, v(n, y ? b.to : b.from, y ? "before" : "after"), "line", t, r), o, l, !0);
          },
          0,
          i.length - 1,
        ),
      ...
      if (a > 0) {
        var u = s.level != 1,
          c = Nt(e, v(n, u ? s.from : s.to, u ? "after" : "before"), "line", t, r);
    ...
    function Wr(e) {
      ...
      if (mr == null) {
        ...
        for (var t = 0; t < 49; ++t) mr.appendChild(document.createTextNode("x")), mr.appendChild(p("br"));
    ...
    function br(e, t, n, r) {
      ...
      if (r && s.xRel > 0 && (u = P(e.doc, s.line).text).length == s.ch) {
        ...
        s = v(s.line, Math.max(0, Math.round((o - Po(e.display).left) / Fr(e.display)) - c));
      }
      return s;
    }
    function xr(e, t) {
    ...
    function tt(e, t, n, r) {
      ...
      if (
      ...
      else if (n <= i.viewFrom) Zt && To(e.doc, n + r) > i.viewFrom ? sr(e) : ((i.viewFrom += r), (i.viewTo += r));
        ...
        var a = Yn(e, t, t, -1),
          s = Yn(e, n, n + r, 1);
        a && s
          ? ((i.view = i.view.slice(0, a.index).concat(Kn(e, a.lineN, s.lineN)).concat(i.view.slice(s.index))),
            (i.viewTo += r))
          : sr(e);
      }
      ...
      function h(A, I, B) {
        ...
        function dt(Me, it, Ke) {
          var Ie = jo(e, R, null, Me),
            ...
            Se = Ke == "after" ? Ie.begin : Ie.end - (/\s/.test(R.text.charAt(Ie.end - 1)) ? 2 : 1);
          return xe(Se, De)[De];
        }
    ...
    function Pr(e, t) {
      e.state.delayingBlurEvent ||
        (e.state.focused && (de(e, "blur", e, t), (e.state.focused = !1), ve(e.display.wrapper, "CodeMirror-focused")),
      ...
      for (
        ...
        if (!a.hidden) {
          if (((i += a.line.height), L && Y < 8)) {
            ...
            (u = b.bottom - b.top),
              !s && a.text.firstChild && (c = a.text.firstChild.getBoundingClientRect().right - b.left - 1);
          }
          var y = a.line.height - u;
          if ((y > 0.005 || y < -0.005) && (i < r && (o -= y), Ct(a.line, u), $o(a.line), a.rest))
            for (var w = 0; w < a.rest.length; w++) $o(a.rest[w]);
          if (c > e.display.sizerWidth) {
            var k = Math.ceil(c / Fr(e.display));
            k > e.display.maxLineLength &&
              ((e.display.maxLineLength = k), (e.display.maxLine = a.line), (e.display.maxLineChanged = !0));
          }
        }
      }
    ...
    function Qn(e, t, n) {
      ...
      if (n && n.ensure) {
        ...
        a < o
          ...
          : Math.min(s, t.lastLine()) >= l && ((o = Pt(t, Qt(P(t, s)) - e.wrapper.clientHeight)), (l = s));
      }
    ...
    function $a(e, t, n, r) {
      ...
      !e.options.lineWrapping &&
        ...
        (t = t.ch ? v(t.line, t.sticky == "before" ? t.ch - 1 : t.ch, "after") : t));
      for (var o = 0; o < 5; o++) {
        var l = !1,
          a = Nt(e, t),
          s = !n || n == t ? a : Nt(e, n);
        ...
        var u = Ri(e, i),
          ...
          h = e.doc.scrollLeft;
        if (
          (u.scrollTop != null && (cn(e, u.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (l = !0)),
          u.scrollLeft != null && (wr(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - h) > 1 && (l = !0)),
          !l)
        )
          break;
      }
    ...
    function es(e, t) {
      var n = Ri(e, t);
      n.scrollTop != null && cn(e, n.scrollTop), n.scrollLeft != null && wr(e, n.scrollLeft);
    }
    function Ri(e, t) {
      var n = e.display,
        r = Wr(e.display);
    ...
    function Bi(e, t) {
      t != null && (Jn(e), (e.curOp.scrollTop = (e.curOp.scrollTop == null ? e.doc.scrollTop : e.curOp.scrollTop) + t));
    }
    function zr(e) {
      Jn(e);
      var t = e.getCursor();
    ...
    function fn(e, t, n) {
      (t != null || n != null) && Jn(e), t != null && (e.curOp.scrollLeft = t), n != null && (e.curOp.scrollTop = n);
    }
    function ts(e, t) {
    ...
    function cn(e, t) {
      Math.abs(e.doc.scrollTop - t) < 2 || (ue || Ki(e, { top: t }), tl(e, t, !0), ue && Ki(e), pn(e, 100));
    }
    function tl(e, t, n) {
    ...
    var kr = function (e, t, n) {
      ...
      (r.tabIndex = i.tabIndex = -1),
        ...
        L && Y < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px");
    };
    ...
    function il(e) {
      e.display.scrollbars &&
        ...
        e.display.scrollbars.addClass && ve(e.display.wrapper, e.display.scrollbars.addClass)),
    ...
    function is(e) {
      ...
      fs(t),
        ...
        (e.update =
          e.mustUpdate && new Vn(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
    }
    function os(e) {
    ...
    function ls(e) {
      ...
      e.updatedDisplay && Zn(t),
        ...
        n.maxLineChanged &&
          ...
          (e.maxScrollLeft = Math.max(0, n.sizer.offsetLeft + e.adjustWidthTo - yr(t)))),
    ...
    function as(e) {
      ...
      e.preparedSelection && t.display.input.showSelection(e.preparedSelection, n),
        (e.updatedDisplay || e.startHeight != t.doc.height) && Hr(t, e.barMeasure),
    ...
    function ss(e) {
      ...
      if (
        ...
        var i = $a(t, Z(r, e.scrollToPos.from), Z(r, e.scrollToPos.to), e.scrollToPos.margin);
        Va(t, i);
      }
      var o = e.maybeHiddenMarkers,
        l = e.maybeUnhiddenMarkers;
      if (o) for (var a = 0; a < o.length; ++a) o[a].lines.length || de(o[a], "hide");
      if (l) for (var s = 0; s < l.length; ++s) l[s].lines.length && de(l[s], "unhide");
    ...
    function pn(e, t) {
      e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, Ae(us, e));
    }
    function us(e) {
      var t = e.doc;
      if (!(t.highlightFrontier >= e.display.viewTo)) {
        ...
        t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
          if (r.line >= e.display.viewFrom) {
            var l = o.styles,
              a = o.text.length > e.options.maxHighlightLength ? Yt(t.mode, r.state) : null,
              s = co(e, o, r, !0);
          ...
          } else o.text.length <= e.options.maxHighlightLength && mi(e, o.text, r), (o.stateAfter = r.line % 5 == 0 ? r.save() : null), r.nextLine();
    ...
    (Vn.prototype.signal = function (e, t) {
      ...
      (Vn.prototype.finish = function () {
        for (var e = 0; e < this.events.length; e++) de.apply(null, this.events[e]);
      });
    function fs(e) {
      var t = e.display;
      !t.scrollbarsClipped &&
    ...
    function Ui(e, t) {
      ...
      Qa(e, o, l), (n.viewOffset = Qt(P(e.doc, n.viewFrom))), (e.display.mover.style.top = n.viewOffset + "px");
      var s = Qo(e);
      if (
        !a &&
        s == 0 &&
      ...
      return (
        ...
        a && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), pn(e, 400)),
    ...
    function ol(e, t) {
      for (var n = t.viewport, r = !0; ; r = !1) {
        if (!r || !e.options.lineWrapping || t.oldDisplayWidth == yr(e)) {
          if (
            (n && n.top != null && (n = { top: Math.min(e.doc.height + Ti(e.display) - Mi(e), n.top) }),
    ...
    function ds(e, t, n) {
      ...
      function a(w) {
        var k = w.nextSibling;
        return (
          W && me && e.display.currentWheelTarget == w ? (w.style.display = "none") : w.parentNode.removeChild(w), k
        );
      }
      for (var s = r.view, u = r.viewFrom, c = 0; c < s.length; c++) {
        ...
        if (!h.hidden)
          if (!h.node || h.node.parentNode != o) {
            ...
            h.changes && ($(h.changes, "gutter") > -1 && (y = !1), Oo(e, h, u, n)),
              y && (S(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(d(e.options, u)))),
    ...
    function qi(e, t) {
      (e.display.sizer.style.minHeight = t.docHeight + "px"),
        ...
        (e.display.gutters.style.height = t.docHeight + e.display.barHeight + Ht(e) + "px");
    }
    function ll(e) {
      var t = e.display,
        n = t.view;
      if (!(!t.alignWidgets && (!t.gutters.firstChild || !e.options.fixedGutter))) {
        for (
          var r = Wi(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", l = 0;
          l < n.length;
          l++
        )
          if (!n[l].hidden) {
    ...
    function ps(e, t, n, r) {
      ...
      (this.input = n),
        ...
        (i.selectionDiv = p("div", null, null, "position: relative; z-index: 1")),
      ...
      (i.mover = p("div", [o], null, "position: relative")),
        ...
        (i.sizerWidth = null),
        (i.heightForcer = p("div", null, null, "position: absolute; height: " + Mr + "px; width: 1px;")),
        (i.gutters = p("div", null, "CodeMirror-gutters")),
        (i.lineGutter = null),
        (i.scroller = p("div", [i.sizer, i.heightForcer, i.gutters], "CodeMirror-scroll")),
        i.scroller.setAttribute("tabIndex", "-1"),
        (i.wrapper = p("div", [i.scrollbarFiller, i.gutterFiller, i.scroller], "CodeMirror")),
        Ze && at >= 105 && (i.wrapper.style.clipPath = "inset(0px)"),
        i.wrapper.setAttribute("translate", "no"),
        L && Y < 8 && ((i.gutters.style.zIndex = -1), (i.scroller.style.paddingRight = 0)),
    ...
    function fl(e, t) {
      ...
      if ((r && s) || (i && u)) {
        ...
        if (i && o != null) {
          ...
          y < 0 ? (w = Math.max(0, w + y - 50)) : (k = Math.min(e.doc.height, k + y + 50)),
            Ki(e, { top: w, bottom: k });
        }
        $n < 20 &&
          t.deltaMode !== 0 &&
              ...
              setTimeout(function () {
                if (l.wheelStartX != null) {
                  var T = a.scrollLeft - l.wheelStartX,
                    ...
                    E = (N && l.wheelDY && N / l.wheelDY) || (T && l.wheelDX && T / l.wheelDX);
                  (l.wheelStartX = l.wheelStartY = null), E && ((Vt = (Vt * $n + E) / ($n + 1)), ++$n);
                }
              }, 200))
    ...
    function fr(e) {
      return e.text
        ? v(e.from.line + e.text.length - 1, te(e.text).length + (e.text.length == 1 ? e.from.ch : 0))
        : e.to;
    }
    function cl(e, t) {
    ...
    function hl(e, t, n) {
      return e.line == t.line ? v(n.line, e.ch - t.ch + n.ch) : v(n.line + (e.line - t.line), e.ch);
    }
    function gs(e, t, n) {
    ...
    function dl(e, t) {
      return t.from.ch == 0 && t.to.ch == 0 && te(t.text) == "" && (!e.cm || e.cm.options.wholeLineUpdateBefore);
    }
    function Zi(e, t, n, r) {
      function i(E) {
        return n ? n[E] : null;
      ...
      if (t.full) e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length);
        ...
        o(h, h.text, y), w && e.remove(a.line, w), k.length && e.insert(a.line, k);
      } else if (c == h)
        if (u.length == 1) o(c, c.text.slice(0, a.ch) + b + c.text.slice(s.ch), y);
        else {
      ...
      else if (u.length == 1) o(c, c.text.slice(0, a.ch) + u[0] + h.text.slice(s.ch), i(0)), e.remove(a.line + 1, w);
      else {
        o(c, c.text.slice(0, a.ch) + u[0], i(0)), o(h, b + h.text.slice(s.ch), y);
    ...
    function ms(e, t) {
      ...
      if (e.done.length > 1 && !e.done[e.done.length - 2].ranges) return e.done.pop(), te(e.done);
    }
    function yl(e, t, n, r) {
      var i = e.history;
      i.undone.length = 0;
      ...
      if (
        ...
        (a = te(l.changes)), x(t.from, t.to) == 0 && x(t.from, a.to) == 0 ? (a.to = fr(t)) : l.changes.push(Qi(e, t));
      else {
        var s = te(i.done);
        for (
          (!s || !s.ranges) && ti(e.sel, i.done), l = { changes: [Qi(e, t)], generation: i.generation }, i.done.push(l);
    ...
    function xs(e, t, n, r) {
      var i = e.history,
        o = r && r.origin;
      n == i.lastSelOp ||
      (o && i.lastSelOrigin == o && ((i.lastModTime == i.lastSelTime && i.lastOrigin == o) || bs(e, o, te(i.done), t)))
      ...
      for (var r = [], i = 0; i < e.length; ++i) {
        ...
        for (var s = 0; s < l.length; ++s) {
          ...
          if ((a.push({ from: u.from, to: u.to, text: u.text }), t))
            for (var h in u)
              (c = h.match(/^spans_(\d+)$/)) && $(t, Number(c[1])) > -1 && ((te(a)[h] = u[h]), delete u[h]);
        }
      }
      return r;
    }
    ...
    function ri(e, t, n, r, i) {
      i == null && (i = e.cm && (e.cm.display.shift || e.extend)), Ye(e, new yt([Ji(e.sel.primary(), t, n, i)], 0), r);
    }
    function xl(e, t, n) {
    ...
    function Ss(e, t, n) {
      var r = {
        ...
        update: function (i) {
          this.ranges = [];
          for (var o = 0; o < i.length; o++) this.ranges[o] = new ae(Z(e, i[o].anchor), Z(e, i[o].head));
        },
        origin: n && n.origin,
      };
      return (
    ...
    function ni(e, t, n) {
      (Qe(e, "beforeSelectionChange") || (e.cm && Qe(e.cm, "beforeSelectionChange"))) && (t = Ss(e, t, n));
      var r = (n && n.bias) || (x(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
      Sl(e, Ll(e, t, r, !0)), !(n && n.scroll === !1) && e.cm && e.cm.getOption("readOnly") != "nocursor" && zr(e.cm);
    }
    function Sl(e, t) {
      t.equals(e.sel) ||
        ((e.sel = t),
          ...
          if (
            ...
            if (n) {
              var h = s.find(r < 0 ? 1 : -1),
                b = void 0;
              if (
                ((r < 0 ? c : u) && (h = Tl(e, h, -r, h && h.line == t.line ? o : null)),
                h && h.line == t.line && (b = x(h, n)) && (r < 0 ? b < 0 : b > 0))
              )
                return Rr(e, h, t, r, i);
            }
            var y = s.find(r < 0 ? -1 : 1);
            return (r < 0 ? u : c) && (y = Tl(e, y, r, y.line == t.line ? o : null)), y ? Rr(e, y, t, r, i) : null;
          }
        }
      return t;
    }
    function ii(e, t, n, r, i) {
      var o = r || 1,
        l = Rr(e, t, n, o, i) || (!i && Rr(e, t, n, o, !0)) || Rr(e, t, n, -o, i) || (!i && Rr(e, t, n, -o, !0));
      ...
      return (
        n &&
          (r.update = function (i, o, l, a) {
            i && (r.from = Z(e, i)), o && (r.to = Z(e, o)), l && (r.text = l), a !== void 0 && (r.origin = a);
          }),
    ...
    function Br(e, t, n) {
      ...
      if (!((Qe(e, "beforeChange") || (e.cm && Qe(e.cm, "beforeChange"))) && ((t = Dl(e, t, !0)), !t))) {
        var r = bo && !n && xa(e, t.from, t.to);
        if (r)
          for (var i = r.length - 1; i >= 0; --i)
            Nl(e, { from: r[i].from, to: r[i].to, text: i ? [""] : t.text, origin: t.origin });
        else Nl(e, t);
      }
    }
    function Nl(e, t) {
      if (!(t.text.length == 1 && t.text[0] == "" && x(t.from, t.to) == 0)) {
        ...
        var r = [];
        cr(e, function (i, o) {
          !o && $(r, i.history) == -1 && (Il(i.history, t), r.push(i.history)), yn(i, t, null, xi(i, t));
        });
      }
    }
    function oi(e, t, n) {
        ...
        if (u != a.length) {
          ...
          for (
            var h = Qe(e, "beforeChange") || (e.cm && Qe(e.cm, "beforeChange")),
              b = function (k) {
                var T = o.changes[k];
                if (((T.origin = t), h && !Dl(e, T, !1))) return (a.length = 0), {};
                c.push(Qi(e, T));
                var N = k ? Yi(e, T) : te(a);
                yn(e, T, N, bl(e, T)), !k && e.cm && e.cm.scrollIntoView({ from: T.from, to: fr(T) });
                var E = [];
                cr(e, function (A, I) {
                  !I && $(E, A.history) == -1 && (Il(A.history, T), E.push(A.history)), yn(A, T, null, bl(A, T));
                });
              },
      ...
      if (
        ...
        (e.sel = new yt(
          Ut(e.sel.ranges, function (i) {
            return new ae(v(i.anchor.line + t, i.anchor.ch), v(i.head.line + t, i.head.ch));
          }),
          e.sel.primIndex,
        )),
        e.cm)
        ...
        for (var n = e.cm.display, r = n.viewFrom; r < n.viewTo; r++) ar(e.cm, r, "gutter");
      }
    }
    function yn(e, t, n, r) {
      ...
      if (!(t.from.line > e.lastLine())) {
        if (t.from.line < e.first) {
          ...
          Al(e, i), (t = { from: v(e.first, 0), to: v(t.to.line + i, t.to.ch), text: [te(t.text)], origin: t.origin });
        }
        var o = e.lastLine();
        t.to.line > o && (t = { from: t.from, to: v(o, P(e, o).text.length), text: [t.text[0]], origin: t.origin }),
    ...
    function Cs(e, t, n) {
      ...
      e.options.lineWrapping ||
        ...
        e.options.lineWrapping ||
          (r.iter(s, o.line + t.text.length, function (y) {
            var w = Un(y);
            w > i.maxLineLength && ((i.maxLine = y), (i.maxLineLength = w), (i.maxLineChanged = !0), (a = !1));
          }),
      ...
      if (h || c) {
        ...
        h && Pe(e, "change", e, b), c && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(b);
      }
    ...
    function El(e, t, n, r) {
      for (var i = 0; i < e.length; ++i) {
        ...
        for (var s = 0; s < o.changes.length; ++s) {
          var u = o.changes[s];
          if (n < u.from.line) (u.from = v(u.from.line + r, u.from.ch)), (u.to = v(u.to.line + r, u.to.ch));
          else if (t <= u.to.line) {
            l = !1;
            break;
          }
    ...
    xn.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        if (this.size - t < 25 && (this.children.length > 1 || !(this.children[0] instanceof bn))) {
          var a = [];
          this.collapse(a), (this.children = [new bn(a)]), (this.children[0].parent = this);
        }
      },
      collapse: function (e) {
    ...
    (wn.prototype.clear = function () {
      ...
      (wn.prototype.changed = function () {
        ...
        i &&
          ...
          n &&
            ht(n, function () {
              (n.curOp.forceUpdate = !0), Wl(n, r, i), Pe(n, "lineWidgetChanged", n, e, le(r));
            }));
      }),
      Je(wn);
    function Wl(e, t, n) {
      ...
      return (
        ...
        mn(e, t, "widget", function (l) {
          ...
          if (
            ...
            Ct(l, l.height + an(i)), s && Bi(o, i.height), (o.curOp.forceUpdate = !0);
          }
          return !0;
        }),
    ...
    (hr.prototype.clear = function () {
      if (!this.explicitlyCleared) {
        ...
        for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
          ...
          e && !this.collapsed
            ...
            a.from == null && this.collapsed && !lr(this.doc, l) && e && Ct(l, Wr(e.display));
        }
      ...
      (hr.prototype.find = function (e, t) {
        ...
        for (var n, r, i = 0; i < this.lines.length; ++i) {
          ...
          if (l.from != null && ((n = v(t ? o : le(o), l.from)), e == -1)) return n;
        ...
        !t ||
          ...
          ht(r, function () {
            var i = t.line,
              ...
              l = Di(r, o);
            if (
              (l && (Bo(l), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
    ...
    function Kr(e, t, n, r, i) {
      ...
      var o = new hr(e, i),
        l = x(t, n);
      if ((r && G(r, o, !1), l > 0 || (l == 0 && o.clearWhenEmpty !== !1))) return o;
      if (
        (o.replacedWith &&
          ((o.collapsed = !0),
        ...
        if (Lo(e, t.line, t, n, o) || (t.line != n.line && Lo(e, n.line, t, n, o)))
      ...
      if (
        (e.iter(a, n.line + 1, function (h) {
          s && o.collapsed && !s.options.lineWrapping && Dt(h) == s.display.maxLine && (u = !0),
            o.collapsed && a != t.line && Ct(h, 0),
            ya(h, new Hn(o, a == t.line ? t.ch : null, a == n.line ? n.ch : null), e.cm && e.cm.curOp),
            ++a;
        }),
        o.collapsed &&
        ...
        o.readOnly && (pa(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
        o.collapsed && ((o.id = ++Fl), (o.atomic = !0)),
        s)
      ) {
        if ((u && (s.curOp.updateMaxLine = !0), o.collapsed)) tt(s, t.line, n.line + 1);
    ...
    function Ts(e, t, n, r, i) {
      ...
      return (
        cr(e, function (s) {
          a && (r.widgetNode = a.cloneNode(!0)), o.push(Kr(s, Z(s, t), Z(s, n), r, i));
    ...
    function Pl(e) {
      return e.findMarks(v(e.first, 0), e.clipPos(v(e.lastLine())), function (t) {
        return t.parent;
      });
    }
    function Ms(e, t) {
      ...
      for (
        var t = function (r) {
            ...
            for (var l = 0; l < i.markers.length; l++) {
              var a = i.markers[l];
              $(o, a.doc) == -1 && ((a.parent = null), i.markers.splice(l--, 1));
            }
          },
          n = 0;
        n < e.length;
    ...
    (rt.prototype = vr(xn.prototype, {
      ...
      setValue: He(function (e) {
        ...
        Br(
          this,
          { from: t, to: v(n, P(this, n).text.length), text: this.splitLines(e), origin: "setValue", full: !0 },
          !0,
        ),
      ...
      setSelections: He(function (e, t, n) {
        if (e.length) {
          for (var r = [], i = 0; i < e.length; i++)
            r[i] = new ae(Z(this, e[i].anchor), Z(this, e[i].head || e[i].anchor));
          t == null && (t = Math.min(e.length - 1, this.sel.primIndex)), Ye(this, At(this.cm, r, t), n);
        }
      }),
      addSelection: He(function (e, t, n) {
        var r = this.sel.ranges.slice(0);
        r.push(new ae(Z(this, e), Z(this, t || e))), Ye(this, At(this.cm, r, r.length - 1), n);
      }),
      ...
      replaceSelections: He(function (e, t, n) {
        ...
        for (var a = t && t != "end" && gs(this, r, t), s = r.length - 1; s >= 0; s--) Br(this, r[s]);
        ...
        this.iter(function (n) {
          n.gutterMarkers &&
            ...
            mn(t, n, "gutter", function () {
              return (n.gutterMarkers[e] = null), U(n.gutterMarkers) && (n.gutterMarkers = null), !0;
            });
        });
      }),
      lineInfo: function (e) {
      ...
      linkedDoc: function (e) {
        ...
        var r = new rt(Ar(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
        return (
...
`
          ...
          if (r && r.length && window.FileReader && window.File)
            for (
              var i = r.length,
                ...
                s = function (y, w) {
                  if (t.options.allowDropFileTypes && $(t.options.allowDropFileTypes, y.type) == -1) {
                    a();
                    return;
                  }
            ...
            try {
              ...
              if (c) {
                ...
                if (
                  ...
                  for (var b = 0; b < h.length; ++b) Ur(t.doc, "", h[b].anchor, h[b].head, "drag");
    ...
    function Os(e, t) {
      ...
      if (
        ...
        (n.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
          Ne && ((n.width = n.height = 1), e.display.wrapper.appendChild(n), (n._top = n.offsetTop)),
      ...
      if (n) {
        ...
        Pi(e, n, r),
          e.display.dragCursor ||
            ((e.display.dragCursor = p("div", null, "CodeMirror-cursors CodeMirror-dragcursors")),
    ...
    function Gr(e, t, n, r) {
      ...
      if (t.fallthrough) {
        if (Object.prototype.toString.call(t.fallthrough) != "[object Array]") return Gr(e, t.fallthrough, n, r);
    ...
    function Kl(e, t) {
      ...
      var n = dr[e.keyCode];
      return n == null || e.altGraphKey ? !1 : (e.keyCode == 3 && e.code && (n = e.code), Ul(n, e, t));
    }
    function ai(e) {
    ...
    function qr(e, t) {
      ...
      ht(e, function () {
        for (var a = r.length - 1; a >= 0; a--) Ur(e.doc, "", r[a].from, r[a].to, "+delete");
        zr(e);
      });
    }
    function $i(e, t, n) {
    ...
    function Hs(e, t, n, r) {
      ...
      var a = function (N, E) {
        ...
        s,
        u = function (N) {
          return e.options.lineWrapping ? ((s = s || Ir(e, t)), jo(e, t, s, N)) : { begin: 0, end: t.text.length };
        },
        c = u(n.sticky == "before" ? a(n, -1) : n.ch);
      if (e.doc.direction == "rtl" || l.level == 1) {
        var h = (l.level == 1) == r < 0,
          b = a(n, h ? 1 : -1);
        if (b != null && (h ? b <= l.to && b <= c.end : b >= l.from && b >= c.begin)) {
      ...
      var w = function (N, E, A) {
          for (
            var I = function (ce, _e) {
              return _e ? new v(n.line, a(ce, 1), "before") : new v(n.line, ce, "after");
            };
            N >= 0 && N < i.length;
            N += E
          ) {
            ...
            if ((B.from <= ee && ee < B.to) || ((ee = R ? B.from : a(B.to, -1)), A.begin <= ee && ee < A.end))
              return I(ee, R);
          }
        },
        k = w(o + r, r, c);
      ...
      return T != null && !(r > 0 && T == t.text.length) && ((k = w(r > 0 ? 0 : i.length - 1, r, u(T))), k) ? k : null;
    }
    var Ln = {
      selectAll: Ml,
      ...
      deleteLine: function (e) {
        return qr(e, function (t) {
          return { from: v(t.from().line, 0), to: Z(e.doc, v(t.to().line + 1, 0)) };
        });
      },
              ...
              if (o) {
                if ((i.ch == o.length && (i = new v(i.line, i.ch - 1)), i.ch > 0))
                  (i = new v(i.line, i.ch + 1)),
                    e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), v(i.line, i.ch - 2), i, "+transpose");
...
`,
    ...
    function si(e, t, n) {
      ...
      var r = e.display.shift,
        i = !1;
      try {
        e.isReadOnly() && (e.state.suppressEdits = !0), n && (e.display.shift = !1), (i = t(e) != se);
      } finally {
    ...
    function Rs(e, t, n) {
      ...
      return (e.options.extraKeys && Gr(t, e.options.extraKeys, n, e)) || Gr(t, e.options.keyMap, n, e);
    }
    var Bs = new J();
    function Tn(e, t, n, r) {
      ...
      return n
        ? t.shiftKey && !e.state.keySeq
          ? Tn(e, "Shift-" + n, t, function (r) {
            ...
            Tn(e, n, t, function (r) {
              if (typeof r == "string" ? /^go[A-Z]/.test(r) : r.motion) return si(e, r);
            })
          : Tn(e, n, t, function (r) {
              return si(e, r);
            })
    ...
    function jl(e) {
      var t = this;
      if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = g(Q(t))), !we(t, e))) {
        ...
        Ne &&
          ((ro = r ? n : null),
          !r && n == 88 && !Wt && (me ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
          ue && !me && !r && n == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
          n == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && Ks(t);
      }
    }
    function Ks(e) {
      ...
      function n(r) {
        (r.keyCode == 18 || !r.altKey) &&
          (ve(t, "CodeMirror-crosshair"), qe(document, "keyup", n), qe(document, "mouseover", n));
      }
    ...
    function Ql(e) {
      ...
      if (
        ...
        !(Jt(t.display, e) || we(t, e) || (e.ctrlKey && !e.altKey) || (me && e.metaKey))
      ) {
        var n = e.keyCode,
          r = e.charCode;
        if (Ne && n == ro) {
    ...
    function Qs(e, t, n, r) {
      ...
      r.addNew
        ? a == -1
          ? ((a = u.length), Ye(o, At(e, u.concat([l]), a), { scroll: !1, origin: "*mouse" }))
          : u.length > 1 && u[a].empty() && r.unit == "char" && !r.extend
          ? (Ye(o, At(e, u.slice(0, a).concat(u.slice(a + 1)), 0), { scroll: !1, origin: "*mouse" }), (s = o.sel))
          : Vi(o, a, l, Et)
          ...
          if (((h = A), r.unit == "rectangle")) {
            for (
              ...
              ce == _e
                ...
                : nt.length > Me && I.push(new ae(v(xe, Me), v(xe, bt(nt, _e, B))));
            }
            I.length || I.push(new ae(n, n)),
              Ye(o, At(e, s.ranges.slice(0, a).concat(I), a), { origin: "*mouse", scroll: !1 }),
              e.scrollIntoView(A);
          } else {
            var it = l,
              Ke = Vl(e, A, r.unit),
      ...
      var N = ze(e, function (A) {
        ...
        E = ze(e, T);
      (e.state.selectingText = E), O(i.wrapper.ownerDocument, "mousemove", N), O(i.wrapper.ownerDocument, "mouseup", E);
    }
    function Js(e, t) {
      var n = t.anchor,
        r = t.head,
    ...
    function ea(e, t) {
      Jt(e.display, t) || Vs(e, t) || we(e, t, "contextmenu") || Tt || e.display.input.onContextMenu(t);
    }
    function Vs(e, t) {
      return Qe(e, "gutterContextMenu") ? $l(e, t, "gutterContextMenu", !1) : !1;
    }
    function ta(e) {
      ...
      (e.defineOption = n),
        ...
        n("lineSeparator", null, function (r, i) {
          if (((r.doc.lineSep = i), !!i)) {
            ...
            for (var a = o.length - 1; a >= 0; a--) Ur(r.doc, i, o[a], v(o[a].line, o[a].ch + i.length));
          }
        }),
        n(
          "specialChars",
          /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b\u200e\u200f\u2028\u2029\u202d\u202e\u2066\u2067\u2069\ufeff\ufff9-\ufffc]/g,
          function (r, i, o) {
            (r.state.specialChars = new RegExp(i.source + (i.test("	") ? "" : "|	"), "g")), o != Xr && r.refresh();
          },
        ),
        n(
        ...
        n("readOnly", !1, function (r, i) {
          i == "nocursor" && (Pr(r), r.display.input.blur()), r.display.input.readOnlyChanged(i);
        }),
    ...
    function ru(e) {
      ...
      O(t.scroller, "touchstart", function (s) {
        ...
        O(t.scroller, "touchend", function (s) {
          var u = t.activeTouch;
          if (u && !Jt(t, s) && u.left != null && !u.moved && new Date() - u.start < 300) {
        ...
        O(t.scroller, "scroll", function () {
          t.scroller.clientHeight &&
            (cn(e, t.scroller.scrollTop), wr(e, t.scroller.scrollLeft, !0), de(e, "scroll", e));
        }),
    ...
    function Nn(e, t, n, r) {
      var i = e.doc,
        o;
      n == null && (n = "add"), n == "smart" && (i.mode.indent ? (o = rn(e, t).state) : (n = "prev"));
      ...
      else if (n == "smart" && ((c = i.mode.indent(o, a.text.slice(u.length), a.text)), c == se || c > 150)) {
        if (!r) return;
        n = "prev";
      }
      n == "prev"
      ...
      var h = "",
        b = 0;
      if (e.options.indentWithTabs) for (var y = Math.floor(c / l); y; --y) (b += l), (h += "	");
      if ((b < c && (h += pt(c - b)), h != u))
        return Ur(i, h, v(t, 0), v(t, u.length), "+input"), (a.stateAfter = null), !0;
...
`) == t
          ...
          if (r.ranges.length % Ot.text.length == 0) {
            u = [];
            for (var c = 0; c < Ot.text.length; c++) u.push(o.splitLines(Ot.text[c]));
          }
        } else
      ...
      for (var h = e.curOp.updateInput, b = r.ranges.length - 1; b >= 0; b--) {
        ...
        y.empty() &&
          (n && n > 0
            ? (w = v(w.line, w.ch - n))
            : e.state.overwrite && !a
            ? (k = v(k.line, Math.min(P(o, k.line).text.length, k.ch + te(s).length)))
            : a &&
              Ot &&
              Ot.lineWise &&
              Ot.text.join(`
...
`) &&
        ...
        for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
          ...
          if (!(i.head.ch > 100 || (r && n.ranges[r - 1].head.line == i.head.line))) {
            ...
            if (o.electricChars) {
              ...
              o.electricInput &&
                o.electricInput.test(P(e.doc, i.head.line).text.slice(0, i.head.ch)) &&
                (l = Nn(e, i.head.line, "smart"));
      ...
      (e.prototype = {
        ...
        setOption: function (r, i) {
          var o = this.options,
            l = o[r];
          (o[r] == i && r != "mode") ||
            ((o[r] = i), t.hasOwnProperty(r) && ze(this, t[r])(this, i, l), de(this, "optionChange", this, r));
        },
        ...
        indentSelection: Ve(function (r) {
          for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
            ...
            if (a.empty())
              a.head.line > o &&
                (Nn(this, a.head.line, r, !0), (o = a.head.line), l == this.doc.sel.primIndex && zr(this));
            else {
              var s = a.from(),
                u = a.to(),
                c = Math.max(o, s.line);
              ...
              s.ch == 0 && i.length == b.length && b[l].from().ch > 0 && Vi(this.doc, l, new ae(s, b[l].to()), pe);
            }
          }
        }),
        ...
        getStateAfter: function (r, i) {
          var o = this.doc;
          return (r = gt(o, r ?? o.first + o.size - 1)), rn(this, r + 1, i).state;
        },
        cursorCoords: function (r, i) {
          var o,
            l = this.doc.sel.primary();
          return (
            r == null ? (o = l.head) : typeof r == "object" ? (o = Z(this.doc, r)) : (o = r ? l.from() : l.to()),
            Nt(this, o, i || "page")
          );
        },
        ...
        lineAtHeight: function (r, i) {
          return (r = qo(this, { top: r, left: 0 }, i || "page").top), Pt(this.doc, r + this.display.viewOffset);
        },
        heightAtLine: function (r, i, o) {
          ...
          if (typeof r == "number") {
            ...
            r < this.doc.first ? (r = this.doc.first) : r > s && ((r = s), (l = !0)), (a = P(this.doc, r));
          } else a = r;
          return qn(this, a, { top: 0, left: 0 }, i || "page", o || l).top + (l ? this.doc.height - Qt(a) : 0);
        },
        ...
        addWidget: function (r, i, o, l, a) {
          ...
          (i.style.top = u + "px"),
            ...
            a == "right"
              ...
              : (a == "left" ? (c = 0) : a == "middle" && (c = (s.sizer.clientWidth - i.offsetWidth) / 2),
                (i.style.left = c + "px")),
            o && es(this, { left: c, top: u, right: c + i.offsetWidth, bottom: u + i.offsetHeight });
        },
        ...
        findPosH: function (r, i, o, l) {
          var a = 1;
          i < 0 && ((a = -1), (i = -i));
          for (var s = Z(this.doc, r), u = 0; u < i && ((s = ao(this.doc, s, a, o, l)), !s.hitSide); ++u);
          return s;
        },
        ...
        moveV: Ve(function (r, i) {
          ...
          if (
            (l.extendSelectionsBy(function (c) {
              ...
              var b = sa(o, h, r, i);
              return i == "page" && c == l.sel.primary() && Bi(o, Xn(o, b, "div").top - h.top), b;
            }, It),
            a.length)
          )
        ...
        scrollIntoView: Ve(function (r, i) {
          r == null
            ...
            r.to || (r.to = r.from),
            (r.margin = i || 0),
            r.from.line != null ? ts(this, r) : el(this, r.from, r.to, r.margin);
        }),
        ...
        refresh: Ve(function () {
          ...
          tt(this),
            ...
            Gi(this.display),
            (r == null || Math.abs(r - Wr(this.display)) > 0.5 || this.options.lineWrapping) && Fi(this),
            de(this, "refresh", this);
        }),
    ...
    function ao(e, t, n, r, i) {
      ...
      function u() {
        var E = t.line + s;
        return E < e.first || E >= e.first + e.size ? !1 : ((t = new v(E, t.ch, t.sticky)), (a = P(e, E)));
      }
      function c(E) {
        var A;
        if (r == "codepoint") {
          ...
          if (isNaN(I)) A = null;
            ...
            A = new v(t.line, Math.max(0, Math.min(a.text.length, t.ch + n * (B ? 2 : 1))), -n);
          }
      ...
      if (r == "char" || r == "codepoint") c();
        ...
        for (
          var h = null, b = r == "group", y = e.cm && e.cm.getHelper(t, "wordChars"), w = !0;
          !(n < 0 && !c(!w));
          w = !1
        ) {
          var k =
...
`
    ...
    function sa(e, t, n, r) {
      var i = e.doc,
        ...
        l;
      if (r == "page") {
        var a = Math.min(e.display.wrapper.clientHeight, Fe(e).innerHeight || i(e).documentElement.clientHeight),
            ...
            var s = oa(r);
              ...
              a.type == "cut" &&
                r.operation(function () {
                  r.setSelections(s.ranges, 0, pe), r.replaceSelection("", null, "cut");
                });
          } else return;
          if (a.clipboardData) {
...
`));
          ...
          K(h),
            setTimeout(function () {
              r.display.lineSpace.removeChild(c), b.focus(), b == i && n.showPrimarySelection();
            }, 50);
        }
      }
      ...
      (fe.prototype.showPrimarySelection = function () {
        ...
        if (!(o && !o.bad && l && !l.bad && x(Ee(o, l), r) == 0 && x(oe(o, l), i) == 0)) {
          ...
          y &&
            ...
            b && e.anchorNode == null ? e.addRange(b) : ue && this.startGracePeriod()),
      ...
      (fe.prototype.pollSelection = function () {
        if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
          var e = this.getSelection(),
            t = this.cm;
          if (Ce && Ze && this.cm.display.gutterSpecs.length && iu(e.anchorNode)) {
          ...
          if (!this.composing) {
            ...
            n &&
              r &&
              ht(t, function () {
                Ye(t.doc, ur(n, r), pe), (n.bad || r.bad) && (t.curOp.selectionChanged = !0);
              });
          }
        }
      }),
      (fe.prototype.pollContent = function () {
        ...
        var e = this.cm,
          ...
          i = n.to();
        if (
          (r.ch == 0 && r.line > e.firstLine() && (r = v(r.line - 1, P(e.doc, r.line - 1).length)),
          i.ch == P(e.doc, i.line).text.length && i.line < e.lastLine() && (i = v(i.line + 1, 0)),
        ...
        if (
          ...
          return !1;
        for (
          var h = e.doc.splitLines(ou(e, a, c, l, u)), b = jt(e.doc, v(l, 0), v(u, P(e.doc, u).text.length));
        ...
        for (
          var y = 0, w = 0, k = h[0], T = b[0], N = Math.min(k.length, T.length);
        ...
        for (
          var E = te(h),
            A = te(b),
            I = Math.min(E.length - (h.length == 1 ? y : 0), A.length - (b.length == 1 ? y : 0));
          w < I && E.charCodeAt(E.length - w - 1) == A.charCodeAt(A.length - w - 1);

        )
          ++w;
        if (h.length == 1 && b.length == 1 && l == r.line)
          for (; y && y > r.ch && E.charCodeAt(E.length - w - 1) == A.charCodeAt(A.length - w - 1); ) y--, w++;
        (h[h.length - 1] = E.slice(0, E.length - w).replace(/^\u200b+/, "")),
          (h[0] = h[0].slice(y).replace(/\u200b+$/, ""));
        var B = v(l, y),
          R = v(u, b.length ? te(b).length - w : 0);
        if (h.length > 1 || h[0] || x(B, R)) return Ur(e.doc, h, B, R, "+input"), !0;
      }),
      ...
      (fe.prototype.onKeyPress = function (e) {
        e.charCode == 0 ||
          ...
          (e.preventDefault(),
          this.cm.isReadOnly() ||
            ze(this.cm, lo)(this.cm, String.fromCharCode(e.charCode == null ? e.keyCode : e.charCode), 0));
      }),
      ...
      function b(y) {
        if (y.nodeType == 1) {
          ...
          if (k) {
            ...
            N.length && (T = N[0].find(0)) && h(jt(e.doc, T.from, T.to).join(a));
            return;
          }
    ...
    function ci(e, t, n) {
      ...
      if (t == e.display.lineDiv) {
        if (((r = e.display.lineDiv.childNodes[n]), !r)) return Yr(e.clipPos(v(e.display.viewTo - 1)), !0);
        (t = null), (n = 0);
      } else
    ...
    function lu(e, t, n) {
      ...
      var h = c(l, a, n);
      if (h) return Yr(h, i);
      for (var b = a.nextSibling, y = l ? l.nodeValue.length - n : 0; b; b = b.nextSibling) {
      ...
      for (var w = a.previousSibling, k = n; w; w = w.previousSibling) {
        if (((h = c(w, w.firstChild, -1)), h)) return Yr(v(h.line, h.ch + k), i);
    ...
    (Le.prototype.init = function (e) {
      ...
      e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
        ...
        O(i, "paste", function (l) {
          we(r, l) || na(l, r) || ((r.state.pasteIncoming = +new Date()), n.fastPoll());
        });
      function o(l) {
        if (!we(r, l)) {
          if (r.somethingSelected()) fi({ lineWise: !1, text: r.getSelections() });
          else if (r.options.lineWiseCopyCut) {
            var a = oa(r);
...
`)),
      ...
      (Le.prototype.reset = function (e) {
        if (!(this.contextMenuPending || (this.composing && e))) {
          ...
          if (((this.resetting = !0), t.somethingSelected())) {
            ...
            (this.textarea.value = n), t.state.focused && K(this.textarea), L && Y >= 9 && (this.hasSelection = n);
          } else e || ((this.prevInput = this.textarea.value = ""), L && Y >= 9 && (this.hasSelection = null));
          this.resetting = !1;
        }
      }),
      ...
      (Le.prototype.focus = function () {
        if (this.cm.options.readOnly != "nocursor" && (!We || g(this.textarea.ownerDocument) != this.textarea))
          try {
            this.textarea.focus();
          } catch {}
      }),
      ...
      (Le.prototype.poll = function () {
        ...
        if ((L && Y >= 9 && this.hasSelection === i) || (me && /[\uf700-\uf7ff]/.test(i)))
...
`) > -1
    ...
    return (
      ...
      (ge.defineMode = function (e) {
        !ge.defaults.mode && e != "null" && (ge.defaults.mode = e), Fn.apply(this, arguments);
      }),
      (ge.defineMIME = Nr),
  ...
  (function (X) {
    ...
    X.defineMode("javascript", function (lt, ue) {
      var Be = lt.indentUnit,
        ...
        at = /[+\-*&%=<>!?|~^@]/,
        Ne = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/;
      function mt(f) {
      ...
      function Ce(f, d) {
        ...
        if (v == "." && f.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return ie("number", "number");
        if (v == "." && f.match("..")) return ie("spread", "meta");
        if (/[\[\]{}\(\),;\:\.]/.test(v)) return ie(v);
        if (v == "=" && f.eat(">")) return ie("=>", "operator");
        if (v == "0" && f.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return ie("number", "number");
        if (/\d/.test(v)) return f.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), ie("number", "number");
        if (v == "/")
          return f.eat("*")
            ...
            : Pt(f, d, 1)
            ? (mt(f), f.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), ie("regexp", "string-2"))
            : (f.eat("="), ie("operator", "operator", f.current()));
        if (v == "`") return (d.tokenize = st), st(f, d);
        if (v == "#" && f.peek() == "!") return f.skipToEnd(), ie("meta", "meta");
        if (v == "#" && f.eatWhile(Ue)) return ie("variable", "property");
        if ((v == "<" && f.match("!--")) || (v == "-" && f.match("->") && !/\S/.test(f.string.slice(0, f.start))))
        ...
        if (at.test(v))
          return (
            ...
            v == "?" && f.eat(".") ? ie(".") : ie("operator", "operator", f.current())
          );
        if (Ue.test(v)) {
          f.eatWhile(Ue);
          var x = f.current();
      ...
      function We(f) {
        return function (d, v) {
          var x = !1,
            j;
          if (ye && d.peek() == "@" && d.match(Ne)) return (v.tokenize = Ce), ie("jsonld-keyword", "meta");
          for (; (j = d.next()) != null && !(j == f && !x); ) x = !x && j == "\\";
      ...
      function be(f, d) {
        ...
        if (!(v < 0)) {
          if (W) {
            var x = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(f.string.slice(f.start, v));
            x && (v = x.index);
          }
      ...
      function ve(f, d, v, x, j) {
        ...
        for (
          ...
          if (oe(v, x)) {
            ...
            return S.marked ? S.marked : v == "variable" && ut(f, x) ? "variable-2" : d;
          }
        }
      }
      ...
      function D(f) {
        ...
        if (((S.marked = "def"), !!Y)) {
          ...
          ue.globalVars && !M(f, d.globalVars) && (d.globalVars = new z(f, d.globalVars));
        }
      }
      function m(f, d) {
        if (d)
      ...
      function Q() {
        (S.state.context = new C(S.state.context, S.state.localVars, !1)), (S.state.localVars = K);
      }
      function Fe() {
        (S.state.context = new C(S.state.context, S.state.localVars, !0)), (S.state.localVars = null);
      }
      Q.lex = Fe.lex = !0;
      function Ae() {
      ...
      function G(f, d) {
        var v = function () {
          ...
          else for (var ne = x.lexical; ne && ne.type == ")" && ne.align; ne = ne.prev) j = ne.indented;
      ...
      function $(f, d) {
        return f == "var"
          ...
          ? p()
          : f == "if"
          ? (S.state.lexical.info == "else" && S.state.cc[S.state.cc.length - 1] == _ && S.state.cc.pop()(),
            p(G("form"), Et, $, _, Dr))
          : f == "function"
          ? p(Wt)
          : f == "for"
          ...
          ? W && d == "declare"
            ? ((S.marked = "keyword"), p($))
            : W && (d == "module" || d == "enum" || d == "type") && S.stream.match(/^\s*\w/, !1)
            ? ((S.marked = "keyword"),
              d == "enum"
                ? p(Ar)
                : d == "type"
      ...
      function pt(f, d, v) {
        ...
        if (f != ";") {
          ...
          if (f == "regexp")
            return (S.state.lastType = S.marked = "operator"), S.stream.backUp(S.stream.pos - S.stream.start - 1), p(j);
        }
      }
      function te(f, d) {
        return f != "quasi" ? F() : d.slice(d.length - 2) != "${" ? p(te) : p(bt, Ut);
      }
      function Ut(f) {
        if (f == "}") return (S.marked = "string-2"), (S.state.tokenize = st), p(te);
      }
      function Oe(f) {
      ...
      function vr(f) {
        return function (d) {
          return d == "." ? p(f ? tr : Qr) : d == "variable" && W ? p(Xe, f ? pt : ft) : F(f ? pe : se);
        };
      }
      function Qr(f, d) {
      ...
      function q(f, d) {
        ...
        if (f == "variable" || S.style == "keyword") {
          ...
          if (f == "number" || f == "string") return (S.marked = ye ? "property" : S.style + " property"), p(re);
      ...
      function V(f, d, v) {
        function x(j, ne) {
          ...
          return j == d || ne == d ? p() : v && v.indexOf(";") > -1 ? F(f) : p(J(d));
        }
      ...
      function kt(f) {
        if (W && f == ":") return S.stream.match(/^\s*\w+\s+is\b/, !1) ? p(se, On, O) : p(O);
      }
      function On(f, d) {
      ...
      function qe(f) {
        return f.match(/[\}\)\]]/) ? p() : f == "," || f == ";" ? p(qe) : F(de, qe);
      }
      function de(f, d) {
        if (f == "variable" || S.style == "keyword") return (S.marked = "property"), p(de);
      ...
      function we(f, d) {
        return f != "quasi" ? F() : d.slice(d.length - 2) != "${" ? p(we) : p(O, En);
      }
      function En(f) {
        if (f == "}") return (S.marked = "string-2"), (S.state.tokenize = st), p(we);
      }
      function Qe(f, d) {
      ...
      function Je(f, d) {
        ...
        if (d == "extends" || d == "implements") return (S.marked = "keyword"), p(O);
        if (d == "?") return p(O, J(":"), O);
      }
      function Xe(f, d) {
        if (d == "<") return p(G(">"), V(O, ">"), _, Je);
      ...
      function qt(f, d) {
        return d == "enum" ? ((S.marked = "keyword"), p(Ar)) : F(et, wt, St, yi);
      }
      function et(f, d) {
      ...
      function $r(f, d) {
        return f == "variable" && !S.stream.match(/^\s*:/, !1)
          ...
          : (f == "variable" && (S.marked = "property"),
            f == "spread" ? p(et) : f == "}" ? F() : f == "[" ? p(se, J("]"), J(":"), $r) : p(J(":"), et, St));
      }
      function gi() {
        return F(et, St);
      }
      ...
      function Wn(f, d) {
        if (f == "keyword" || f == "variable") return (S.marked = "type"), p(Wn);
      ...
      function ct(f, d) {
        ...
        if (f == "variable" || S.style == "keyword") return (S.marked = "property"), p(Xt, ct);
      ...
      function Yt(f) {
        return f == "string" ? p() : f == "(" ? F(se) : f == "." ? F(ft) : F(or, tn, P);
      }
      function or(f, d) {
        return f == "{" ? vt(or, "}") : (f == "variable" && D(d), d == "*" && (S.marked = "keyword"), p(ke));
      }
      function tn(f) {
        if (f == ",") return p(or, tn);
      }
      ...
      function le(f, d) {
        return f.lastType == "operator" || f.lastType == "," || at.test(d.charAt(0)) || /[,.]/.test(d.charAt(0));
      }
      function Pt(f, d, v) {
        return (
          (d.tokenize == Ce &&
            /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(d.lastType)) ||
          (d.lastType == "quasi" && /\{\s*$/.test(f.string.slice(0, f.pos - (v || 0))))
        );
      }
      return {
        startState: function (f) {
          ...
          return ue.globalVars && typeof ue.globalVars == "object" && (d.globalVars = ue.globalVars), d;
        },
        token: function (f, d) {
          if (
            (f.sol() &&
              (d.lexical.hasOwnProperty("align") || (d.lexical.align = !1), (d.indented = f.indentation()), be(f, d)),
          ...
          return Te == "comment"
            ? v
            : ((d.lastType = Te == "operator" && (Ge == "++" || Ge == "--") ? "incdec" : Te), ve(d, v, Te, Ge, f));
        },
        indent: function (f, d) {
          ...
          for (
            ...
            (v == "}" || ((j = f.cc[f.cc.length - 1]) && (j == ft || j == pt) && !/^[,\.=+\-*:?[\(]/.test(d)));
      ...
      X.defineMIME("application/manifest+json", { name: "javascript", json: !0 }),
...
(function (An, pi) {
  (function (X) {
    ...
    X.registerHelper("hintWords", "python", Be.concat(Lt).concat(["exec", "print"]));
    function ye(Y) {
    ...
    X.defineMode("python", function (Y, W) {
      for (
        var Ue = "error",
          Ze = W.delimiters || W.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/,
          at = [
            W.singleOperators,
            W.doubleOperators,
            W.doubleDelimiters,
      ...
      if (ie) {
        ...
        (Te = Te.concat(["nonlocal", "False", "True", "None", "async", "await"])),
          (Ge = Ge.concat(["ascii", "bytes", "exec", "print"]));
        var We = new RegExp(`^(([rbuf]|(br)|(rb)|(fr)|(rf))?('{3}|"{3}|['"]))`, "i");
      } else {
        var Ce = W.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
      ...
      function he(M, D) {
        ...
        if ((m && (D.indent = M.indentation()), m && ye(D).type == "py")) {
          ...
          if (M.eatSpace()) {
            var C = M.indentation();
            return C > g ? ut(D) : C < g && S(M, D) && M.peek() != "#" && (D.errorToken = !0), null;
          } else {
            var z = be(M, D);
      ...
      function be(M, D, m) {
        ...
        for (var K = 0; K < at.length; K++) if (M.match(at[K])) return "operator";
        return M.match(Ze)
          ? "punctuation"
      ...
      function Bt(M, D) {
        for (; "rubf".indexOf(M.charAt(0).toLowerCase()) >= 0; ) M = M.substr(1);
        var m = M.length == 1,
          g = "string";
        function C(K) {
          return function (Q, Fe) {
            ...
            return (
              Ae == "punctuation" &&
                (Q.current() == "{"
                  ? (Fe.tokenize = C(K + 1))
                  : Q.current() == "}" && (K > 1 ? (Fe.tokenize = C(K - 1)) : (Fe.tokenize = z))),
              Ae
            );
          };
        }
        function z(K, Q) {
          for (; !K.eol(); )
            if ((K.eatWhile(/[^'"\{\}\\]/), K.eat("\\"))) {
              ...
              if (K.match("{{")) return g;
              if (K.match("{", !1)) return (Q.tokenize = C(0)), K.current() ? g : Q.tokenize(K, Q);
              if (K.match("}}")) return g;
      ...
      function ut(M) {
        ...
        M.scopes.push({ offset: ye(M).offset + Y.indentUnit, type: "py", align: null });
      }
      function ve(M, D, m) {
      ...
      function S(M, D) {
        for (var m = M.indentation(); D.scopes.length > 1 && ye(D).offset > m; ) {
      ...
      function F(M, D) {
        ...
        var m = D.tokenize(M, D),
          g = M.current();
        if (D.beginningOfLine && g == "@") return M.match(Ce, !1) ? "meta" : ie ? "operator" : Ue;
        if (
          (/\S/.test(g) && (D.beginningOfLine = !1),
          (m == "variable" || m == "builtin") && D.lastToken == "meta" && (m = "meta"),
          (g == "pass" || g == "return") && (D.dedent = !0),
          g == "lambda" && (D.lambda = !0),
          g == ":" && !D.lambda && ye(D).type == "py" && M.match(/^\s*(?:#|$)/, !1) && ut(D),
          g.length == 1 && !/string|comment/.test(m))
        ) {
          var C = "[({".indexOf(g);
          if ((C != -1 && ve(M, D, "])}".slice(C, C + 1)), (C = "])}".indexOf(g)), C != -1))
            if (ye(D).type == g) D.indent = D.scopes.pop().offset - mt;
            else return Ue;
        }
        return D.dedent && M.eol() && ye(D).type == "py" && D.scopes.length > 1 && D.scopes.pop(), m;
      }
      var p = {
        ...
        token: function (M, D) {
          ...
          var g = F(M, D);
          return (
            g && g != "comment" && (D.lastToken = g == "keyword" || g == "punctuation" ? M.current() : g),
        ...
        indent: function (M, D) {
          ...
          var m = ye(M),
            g = m.type == D.charAt(0) || (m.type == "py" && !M.dedent && /^(else:|elif |except |finally:)/.test(D));
          return m.align != null ? m.align - (g ? 1 : 0) : m.offset - (g ? mt : 0);
        },
...
(function (An, pi) {
  (function (X) {
    ...
    function lt(m, g, C, z, K, Q) {
      (this.indented = m), (this.column = g), (this.type = C), (this.info = z), (this.align = K), (this.prev = Q);
    }
    function ue(m, g, C, z) {
      var K = m.indented;
      return (
        m.context && m.context.type == "statement" && C != "statement" && (K = m.context.indented),
        (m.context = new lt(K, g, C, z, null, m.context))
      );
    }
    function Be(m) {
      var g = m.context.type;
      return (g == ")" || g == "]" || g == "}") && (m.indented = m.context.indented), (m.context = m.context.prev);
    }
    function Lt(m, g, C) {
      if (
    ...
    X.defineMode("clike", function (m, g) {
      var C = m.indentUnit,
        ...
        bt = g.numberStart || /[\d\.]/,
        ft = g.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
        pt = g.isOperatorChar || /[+\-*&%=<>!?|\/]/,
      ...
      function Gt(U, q) {
        g.typeFirstDefinitions && U.eol() && ye(q.context) && (q.typeAtEndOfLine = Lt(U, q, U.pos));
      }
      return {
        ...
        token: function (U, q) {
          var H = q.context;
          if (
            (U.sol() && (H.align == null && (H.align = !1), (q.indented = U.indentation()), (q.startOfLine = !0)),
            U.eatSpace())
          )
            return Gt(U, q), null;
          Oe = Kt = null;
          ...
          if (
            ...
            for (H.type == "}" && (H = Be(q)); H.type == "statement"; ) H = Be(q);
          } else
            Oe == H.type
              ? Be(q)
              : se &&
          ...
          if (
            (re == "variable" &&
              (q.prevToken == "def" ||
                (g.typeFirstDefinitions && Lt(U, q, U.start) && ye(q.context) && U.match(/^\s*\(/, !1))) &&
              (re = "def"),
            $.token)
          ) {
            var V = $.token(U, q, re);
        ...
        indent: function (U, q) {
          if ((U.tokenize != vr && U.tokenize != null) || U.typeAtEndOfLine) return X.Pass;
          var H = U.context,
            re = q && q.charAt(0),
            V = re == H.type;
          if ((H.type == "statement" && re == "}" && (H = H.prev), g.dontIndentStatements))
            for (; H.type == "statement" && g.dontIndentStatements.test(H.info); ) H = H.prev;
          if ($.indent) {
          ...
          return H.type == "statement"
            ...
            : H.type == ")" && !V
            ? H.indented + z
            : H.indented + (V ? 0 : C) + (!V && xt && !/^(?:case|default)\b/.test(q) ? C : 0);
        },
        electricInput: pe ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
        blockCommentStart: "/*",
        blockCommentEnd: "*/",
    ...
    function be(m, g) {
      if ((m.backUp(1), m.match(/^(?:R|u8R|uR|UR|LR)/))) {
        ...
        return C ? ((g.cpp11RawStringDelim = C[1]), (g.tokenize = ut), ut(m, g)) : !1;
      }
    ...
    function ve(m, g) {
      ...
      z(g.keywords),
        ...
        z(g.builtin),
        z(g.atoms),
        C.length && ((g.helperType = m[0]), X.registerHelper("hintWords", m[0], C));
    ...
    ve(["text/x-csrc", "text/x-c", "text/x-chdr"], {
      ...
      ve("text/x-csharp", {
        ...
        hooks: {
          "@": function (m, g) {
            return m.eat('"') ? ((g.tokenize = Tt), Tt(m, g)) : (m.eatWhile(/[\w\$_]/), "meta");
          },
        },
      });
    function S(m, g) {
    ...
    function F(m) {
      return function (g, C) {
        for (var z; (z = g.next()); )
          ...
          else if (z == "/" && g.eat("*")) return (C.tokenize = F(m + 1)), C.tokenize(g, C);
        return "comment";
      };
    }
    ve("text/x-scala", {
      ...
      hooks: {
        ...
        "=": function (m, g) {
          ...
          return C.type == "}" && C.align && m.eat(">")
            ? ((g.context = new lt(C.indented, C.column, C.type, C.info, null, C.prev)), "operator")
            : !1;
        },
        "/": function (m, g) {
    ...
    function p(m) {
      return function (g, C) {
        for (var z = !1, K, Q = !1; !g.eol(); ) {
          ...
          (K = g.next()), !z && K == "$" && g.match("{") && g.skipTo("}"), (z = !z && K == "\\" && !m);
        }
    ...
    ve("text/x-kotlin", {
      ...
      hooks: {
        ...
        indent: function (m, g, C, z) {
          var K = C && C.charAt(0);
          if ((m.prevToken == "}" || m.prevToken == ")") && C == "") return m.indented;
          if (
          ...
          if (g.align && g.type == "}") return g.indented + (m.context.type == (C || "").charAt(0) ? 0 : z);
        },
      },
      ...
      ve("text/x-objectivec", {
        ...
        types: Ge,
        builtin: L(at),
        blockKeywords: L(ie + " @synthesize @try @catch @finally @autoreleasepool @synchronized"),
      ...
      ve("text/x-objectivec++", {
        ...
        types: Ge,
        builtin: L(at),
        blockKeywords: L(ie + " @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch"),
        defKeywords: L(Ce + " @interface @implementation @protocol @class class namespace"),
        dontIndentStatements: /^@.*$|^template$/,
        typeFirstDefinitions: !0,
        atoms: L("YES NO NULL Nil nil true false nullptr"),
        isReservedIdentifier: st,
    ...
    ve("text/x-ceylon", {
      ...
      hooks: {
        ...
        '"': function (m, g) {
          return (g.tokenize = D(m.match('""') ? "triple" : "single")), g.tokenize(m, g);
        },
        "`": function (m, g) {
          return !M || !m.match("`") ? !1 : ((g.tokenize = M), (M = null), g.tokenize(m, g));
        },
        "'": function (m) {
          return m.eatWhile(/[\w\$_\xa1-\uffff]/), "atom";
        },
        token: function (m, g, C) {
          if ((C == "variable" || C == "type") && g.prevToken == ".") return "variable-2";
        },
      },
